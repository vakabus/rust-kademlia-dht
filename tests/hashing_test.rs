...
fn test_hashing() {
    ...
    assert_eq!(to_hex_string(hash), "5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8");
}
...
fn test_empty_hash() {
    let data = b"";
    let hash: Vec<u8> = SHA1Hasher::hash(&data[..]);
    assert_eq!(to_hex_string(hash), "da39a3ee5e6b4b0d3255bfef95601890afd80709");
}
